                    ...
                    <div class="card">
                        <div class="">
                            <div id="cart-item" v-for="cart in cart_info" :key="cart.p_name">
                                <div class="cart-item d-md-flex justify-content-between"><a @click="deleteThisProductFromCart(cart.cart_number)"><span class="remove-item"> <font-awesome-icon icon="fa fa-times" /> </span></a>
                                    <div class="px-4 my-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <dl class="dlist-align">
                                <dt>총 상품수: &nbsp;</dt>
                                <dd class="text-right ml-3">{{ cart_info.length }} </dd>
                            </dl>
                            <dl class="dlist-align">
                                <dt>총 상품금액: &nbsp;</dt>
    ...
    export default {
       data() {
        ...
        methods: {
            ...
            async deleteThisProductFromCart(cnum) {
